...
router.get('/', auth_1.basicAuth, getAll);
router.get('/:id([0-9]{1,})', auth_1.basicAuth, getById);
router.post('/', (0, koa_bodyparser_1.default)(), auth_1.basicAuth, validation_1.validateUser, createUser);
router.put('/:id([0-9]{1,})', auth_1.basicAuth, (0, koa_bodyparser_1.default)(), validation_1.validateUser, updateUser);
